...
export default function Kontakto() {
  return (
    <>
      <Header></Header>{" "}
      <section className="dark:bg-dark relative z-10 overflow-hidden bg-navyBlue py-20 lg:py-[120px]">
        <div className="container mx-auto">
          <div className="mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <span className="mb-4 block text-base font-semibold text-white/50">
                  Na kontaktoni
                </span>
                ...
                <p className="dark:text-dark-6 mb-9 text-base leading-relaxed text-white/60"></p>
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="dark:text-dark-6 text-base text-white/50">
              ...
              <div className="dark:bg-dark-2 relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="border-primary w-full rounded border bg-purple p-3 text-white transition hover:bg-opacity-90"
                    >
                      Dërgo mesazhin
                    </button>
                  </div>
